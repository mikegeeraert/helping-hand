...
void GpioSetup(void)
{
  ...
  AT91C_BASE_PIOA->PIO_AIMER  = PIOA_AIMER_INIT;
  AT91C_BASE_PIOA->PIO_AIMDR  = PIOA_AIMDR_INIT;
  AT91C_BASE_PIOA->PIO_ESR    = PIOA_ESR_INIT;
  AT91C_BASE_PIOA->PIO_LSR    = PIOA_LSR_INIT;
  AT91C_BASE_PIOA->PIO_FELLSR = PIOA_FELLSR_INIT;
  AT91C_BASE_PIOA->PIO_REHLSR = PIOA_REHLSR_INIT;
  ...
  AT91C_BASE_PIOB->PIO_AIMER  = PIOB_AIMER_INIT;
  AT91C_BASE_PIOB->PIO_AIMDR  = PIOB_AIMDR_INIT;
  AT91C_BASE_PIOB->PIO_ESR    = PIOB_ESR_INIT;
  AT91C_BASE_PIOB->PIO_LSR    = PIOB_LSR_INIT;
  AT91C_BASE_PIOB->PIO_FELLSR = PIOB_FELLSR_INIT;
  AT91C_BASE_PIOB->PIO_REHLSR = PIOB_REHLSR_INIT;
